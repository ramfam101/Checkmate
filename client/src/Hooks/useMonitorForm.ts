...
const getBaseDefaults = (data?: Monitor | null) => ({
	...
	incidentEscalationEnabled: data?.incidentEscalationEnabled ?? false,
	incidentEscalationMinutes: data?.incidentEscalationMinutes ?? 30,
	incidentEscalationNotificationIds: data?.incidentEscalationNotificationIds || [],
