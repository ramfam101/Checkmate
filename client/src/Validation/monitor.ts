...
const baseSchema = z.object({
	...
	escalatedNotificationMinutes: z.preprocess(
		(val) => (val === "" ? undefined : val),
		z.coerce.number().int().min(1, "Escalation delay must be at least 1 minute").optional()
	),
	escalatedNotificationId: z.string().optional(),
	statusWindowSize: z
