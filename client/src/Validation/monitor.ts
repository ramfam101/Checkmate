...
const baseSchema = z.object({
	...
	escalationIntervals: z.array(z.number().min(1, "Escalation delay must be at least 1 minute")),
	maxEscalationAlerts: z
		.number()
		.min(1, "Escalation alert count must be at least 1")
		.max(10, "Escalation alert count must be at most 10"),
	statusWindowSize: z
