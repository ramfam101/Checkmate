			...
			rightContent={
				...
				<Controller
					...
					render={({ field, fieldState }) => (
						...
						fieldLabel={t("pages.createMonitor.form.escalation.option.escalationAfterMinutes.label")}
						placeholder="0"
						fullWidth
						error={!!fieldState.error}
						helperText={fieldState.error?.message ?? ""}
				...
				{/* Escalation Notifications (same UI as notifications) */}
				<Controller
					...
					return (
						<Stack spacing={theme.spacing(LAYOUT.MD)}>
						<Typography component="label" sx={{fontSize: "14px", fontWeight: 500, color: theme.palette.text.secondary, marginBottom: theme.spacing(2), display: "block",}}>
						{t("pages.createMonitor.form.escalation.option.escalationNotifications.label")}
						</Typography>
