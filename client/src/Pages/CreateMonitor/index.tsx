			...
			rightContent={
				...
				<Controller
					...
					<TextField
						...
						fieldLabel={t("pages.createMonitor.form.escalationRules.option.escalationTime.label")}
						fullWidth
						error={!!fieldState.error}
						helperText={fieldState.error?.message ?? ""}
					/>
				...
				<Controller
					...
					return (
						...
						<Autocomplete
							...
							isOptionEqualToValue={(option, value) => option.id === value.id}
							fieldLabel={t("pages.createMonitor.form.escalationRules.option.notifyChannels.label")}
						/>
						{selectedNotifications.length > 0 && (
