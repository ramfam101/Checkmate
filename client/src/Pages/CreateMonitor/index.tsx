					...
					<Stack spacing={theme.spacing(LAYOUT.MD)}>
						...
						<Controller
							...
							render={({ field }) => {
								...
								const getEscalationChannelLabel = (label: string) =>
									label.replace(/\bbase email\b/i, "escalation email");
									...
									<Stack spacing={theme.spacing(LAYOUT.MD)}>
										<Autocomplete
											...
											getOptionLabel={(option) =>
												getEscalationChannelLabel(option.name)
											}
											onChange={(_: unknown, newValue: typeof notificationOptions) => {
										...
										{selectedEscalationNotifications.length > 0 && (
											...
											>
												{selectedEscalationNotifications.map((notification, index) => (
													...
													>
														<Typography flexGrow={1}>
															{getEscalationChannelLabel(notification.notificationName)}
														</Typography>
														<IconButton
															size="small"
															onClick={() => {
