				...
				rightContent={
					<Stack spacing={theme.spacing(LAYOUT.MD)}>
						<Controller
							...
							render={({ field }) => (
								<Select
									label={t("pages.createMonitor.form.escalation.delay.label")}
									value={field.value ?? ""}
									onChange={(e) =>
								...
								>
									<MenuItem
										...
										disabled
									>
										{t("pages.createMonitor.form.escalation.delay.placeholder")}
									</MenuItem>
									{[1, 5, 10, 15, 30, 60, 120, 240, 480, 720, 1440].map((minutes) => (
										<MenuItem
											key={minutes}
											value={minutes}
										>
