				...
				rightContent={
					<Stack spacing={theme.spacing(LAYOUT.MD)}>
						<Stack spacing={theme.spacing(SPACING.MD)}>
							...
							<Stack>
								<Typography variant="subtitle2">
									{t("pages.createMonitor.form.escalation.channelsLabel")}
								</Typography>
								<Controller
										...
										return (
											<Stack spacing={theme.spacing(LAYOUT.MD)}>
												<Autocomplete
													...
													isOptionEqualToValue={(option, value) => option.id === value.id}
													placeholder={t(
														"pages.createMonitor.form.escalation.channelsPlaceholder"
													)}
												/>
												{selectedNotifications.length > 0 && (
													<Stack
						...
						<Typography
							...
							color="textSecondary"
						>
							{t("pages.createMonitor.form.escalation.helpText")}
						</Typography>
					</Stack>
				}
			/>
