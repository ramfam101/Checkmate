	...
	return (
		...
		>
			...
			<ConfigBox
				...
				rightContent={
					<Stack spacing={theme.spacing(LAYOUT.MD)}>
						{/* Escalate after section */}
						<Stack spacing={theme.spacing(LAYOUT.SM)}>
							<Typography variant="h6" sx={{ fontWeight: 600 }}>
								{t("pages.createMonitor.form.escalation.delay.title")}
							</Typography>
							<Controller
								...
								render={({ field, fieldState }) => (
									<TextField
										...
										type="number"
										fieldLabel={t("pages.createMonitor.form.escalation.delay.option.delayMinutes.label")}
										fullWidth
										error={!!fieldState.error}
										helperText={fieldState.error?.message ?? ""}
										inputProps={{ min: 1 }}
						...
						{/* Escalation notification channels section */}
						<Stack spacing={theme.spacing(LAYOUT.SM)}>
							<Typography variant="h6" sx={{ fontWeight: 600 }}>
								{t("pages.createMonitor.form.escalation.notifications.title")}
							</Typography>
							<Typography variant="body2" color="text.secondary" sx={{ mb: 1 }}>
								{t("pages.createMonitor.form.escalation.notifications.description")}
							</Typography>
							<Controller
