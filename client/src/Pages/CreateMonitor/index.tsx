...
const CreateMonitorPage = () => {
    ...
    return (
        ...
        >
                                ...
                                <FormControl error={!!fieldState.error}>
                                    ...
                                    >
                                        ...
                                        <RadioWithDescription
                                            ...
                                            description={t("pages.createMonitor.form.type.optionDockerDescription")}
                                        />
                                        <RadioWithDescription
                                            value="port"
                                        ...
                                        <RadioWithDescription
                                            ...
                                            description={t("pages.createMonitor.form.type.optionGrpcDescription")}
                                        />
                                        <RadioWithDescription
                                            value="websocket"
                                            label={t("pages.common.monitors.monitorTypes.optionWebSocket")}
                                            description={t("pages.createMonitor.form.type.optionWebSocketDescription")}
                                        />
                                    </RadioGroup>
                                </FormControl>
                            )}
                            ...
                            <Controller
                                ...
                                render={({ field }) => (
                                    <SliderWithLabel
                                        ...
                                        fieldLabel={t("pages.createMonitor.form.thresholds.option.cpuThreshold.label")}
                                        min={0}
                                        max={100}
                                        step={1}
                            ...
                            <Controller
                                ...
                                render={({ field }) => (
                                    <SliderWithLabel
                                        {...field}
                                        sliderMaxWidth={{ xs: "100%", md: "50%" }}
                                        fieldLabel={t("pages.createMonitor.form.thresholds.option.memoryThreshold.label")}
                                        min={0}
                                        max={100}
                                        step={1}
                                        valueLabelDisplay="auto"
                            ...
                            <Controller
                                ...
                                render={({ field }) => (
                                    <SliderWithLabel
                                        {...field}
                                        sliderMaxWidth={{ xs: "100%", md: "50%" }}
                                        fieldLabel={t("pages.createMonitor.form.thresholds.option.diskThreshold.label")}
                                        min={0}
                                        max={100}
                                        step={1}
                                        valueLabelDisplay="auto"
                            ...
                            <Controller
                                ...
                                render={({ field }) => (
                                    <SliderWithLabel
                                        {...field}
                                        sliderMaxWidth={{ xs: "100%", md: "50%" }}
                                        fieldLabel={t("pages.createMonitor.form.thresholds.option.tempThreshold.label")}
                                        min={0}
                                        max={100}
                                        step={1}
                                        valueLabelDisplay="auto"
            ...
            <ConfigBox
                title={t("pages.createMonitor.form.escalation.channels.title")}
                subtitle={t("pages.createMonitor.form.escalation.channels.description")}
                rightContent={
                    <Controller
                                        ...
                                        render={({ field }) => (
                                            ...
                                            >
                                                <MenuItem value="equal">
                                                    {t("pages.createMonitor.form.advanced.option.matchMethod.equal")}
                                                </MenuItem>
                                                <MenuItem value="include">
                                                    {t("pages.createMonitor.form.advanced.option.matchMethod.include")}
                                                </MenuItem>
                                                <MenuItem value="regex">
                                                    {t("pages.createMonitor.form.advanced.option.matchMethod.regex")}
                                                </MenuItem>
                                            </Select>
                                        )}
                                    />
                                    ...
                                    <Controller
                                        ...
                                        render={({ field }) => (
                                            <Select
                                                ...
                                                fieldLabel={t("pages.createMonitor.form.geoChecks.option.interval.label")}
                                            >
                                                <MenuItem value={300000}>
                                                    {t("pages.createMonitor.form.geoChecks.option.interval.value.fiveMinutes")}
                                                </MenuItem>
                                                <MenuItem value={600000}>
                                                    {t("pages.createMonitor.form.geoChecks.option.interval.value.tenMinutes")}
                                                </MenuItem>
                                                <MenuItem value={900000}>
                                                    {t("pages.createMonitor.form.geoChecks.option.interval.value.fifteenMinutes")}
                                                </MenuItem>
                                                <MenuItem value={1800000}>
                                                    {t("pages.createMonitor.form.geoChecks.option.interval.value.thirtyMinutes")}
                                                </MenuItem>
                                            </Select>
                                        )}
                                    />
