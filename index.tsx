	...
	return (
		...
		>
			...
			<ConfigBox
				...
				subtitle={t("If the monitor is down for the specified time, notify additional channels.")}
				rightContent={
					<Stack spacing={theme.spacing(LAYOUT.MD)}>
						<Controller
							name="escalationTime"
							...
							render={({ field, fieldState }) => (
								<Stack spacing={theme.spacing(2)}>
									<Typography sx={{ fontSize: "14px", fontWeight: 500 }}>
										{t("pages.createMonitor.form.escalation.timeLabel")}
									</Typography>
									<TextField
										value={field.value ?? ""}
										onChange={(e) => {
						...
						<Controller
							...
							render={({ field }) => {
								...
								return (
									<Stack spacing={theme.spacing(LAYOUT.MD)}>
										<Typography sx={{ fontSize: "14px", fontWeight: 500 }}>
											{t("pages.createMonitor.form.escalation.channelLabel")}
										</Typography>
										<Autocomplete
											multiple
											options={notificationOptions}
											...
											renderInput={(params) => (
												<TextField
													{...params}
													placeholder={t("pages.createMonitor.form.escalation.channelPlaceholder")}
												/>
											)}
											slotProps={{
												paper: {
