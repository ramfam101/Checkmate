...
class MongoMonitorsRepository implements IMonitorsRepository {
	...
	private toEntity = (doc: MonitorDocument): Monitor => {
		...
		return {
			...
			lastEscalationIndex: typeof doc.lastEscalationIndex === "number" ? doc.lastEscalationIndex : -1,
			escalationSent: typeof doc.escalationSent === "boolean" ? doc.escalationSent : false,
			lastStatusNotification: doc.lastStatusNotification ?? undefined,
			downSince: typeof doc.downSince === "number" ? doc.downSince : undefined,
