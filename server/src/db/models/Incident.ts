...
type IncidentDocumentBase = Omit<
	Incident,
	"id" | "monitorId" | "teamId" | "resolvedBy" | "startTime" | "endTime" | "createdAt" | "updatedAt" | "escalationNotificationSentIds"
> & {
	...
	createdAt: Date;
	updatedAt: Date;
	escalationNotificationSentIds: string[];
};
