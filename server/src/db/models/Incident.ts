...
type IncidentDocumentBase = Omit<
	Incident,
	"id" | "monitorId" | "teamId" | "resolvedBy" | "startTime" | "endTime" | "sentEscalationDelays" | "sentEscalationKeys" | "createdAt" | "updatedAt"
> & {
	...
	startTime: Date;
	endTime: Date | null;
	sentEscalationDelays: number[];
	sentEscalationKeys: string[];
	createdAt: Date;
	updatedAt: Date;
};
