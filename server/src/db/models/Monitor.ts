...
> & {
	...
	notifications: (Types.ObjectId | string)[];
	escalationRules: { delayMinutes: number; notificationId: Types.ObjectId | string }[];
		...
		escalationRules: [
			{
				...
				notificationId: { type: Schema.Types.Mixed, required: true },
			},
		],
		recentChecks: {
