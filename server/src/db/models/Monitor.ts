...
import type { NotificationConfig } from "@/types/monitor.js";
import type {
	CheckAudits,
	CheckCaptureInfo,
	CheckCpuInfo,
...
> & {
	...
	notifications: Array<{ notificationId: Types.ObjectId; escalations: Array<{ delayMinutes: number; channelId: Types.ObjectId }> }>;
