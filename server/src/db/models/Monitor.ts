...
> & {
	...
	escalations: Array<Omit<MonitorEscalation, "channelId"> & { channelId: Types.ObjectId }>;
...
const escalationSchema = new Schema<Omit<MonitorEscalation, "channelId"> & { channelId: Types.ObjectId }>(
	{
