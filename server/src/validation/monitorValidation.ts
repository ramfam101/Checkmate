...
export const createMonitorBodyValidation = z.object({
	...
	escalationChannelId: z.union([z.string(), z.literal("")]).optional(),
...
const importedMonitorSchema = z.object({
	...
	enableEscalation: z.boolean().default(false),
	escalationDelayMinutes: z.number().default(10),
	escalationChannelId: z.union([z.string(), z.literal("")]).default(""),
	secret: z.string().optional(),
