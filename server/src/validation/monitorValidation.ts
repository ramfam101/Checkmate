...
export const createMonitorBodyValidation = z.object({
	...
	escalationAfterMinutes: z.union([z.number().int().min(1), z.null()]).optional(),
...
const importedMonitorSchema = z.object({
	...
	escalationAfterMinutes: z.union([z.number().int().min(1), z.null()]).default(null),
	escalationNotificationChannels: z.array(z.string()).default([]),
	secret: z.string().optional(),
