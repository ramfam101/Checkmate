...
const escalationNotificationSchema = z.object({
...
export const createMonitorBodyValidation = z.object({
	...
	escalationNotifications: z.array(escalationNotificationSchema).optional(),
...
const importedMonitorSchema = z.object({
	...
	escalationNotifications: z.array(escalationNotificationSchema).default([]),
	secret: z.string().optional(),
