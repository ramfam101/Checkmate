...
export const createMonitorBodyValidation = z.object({
	...
	incidentEscalationEnabled: z.boolean().optional(),
	incidentEscalationMinutes: z.number().int().min(1).max(10080).optional(),
	incidentEscalationNotificationIds: z.array(z.string()).optional(),
...
const importedMonitorSchema = z.object({
	...
	incidentEscalationEnabled: z.boolean().default(false),
	incidentEscalationMinutes: z.number().int().min(1).max(10080).default(30),
	incidentEscalationNotificationIds: z.array(z.string()).default([]),
