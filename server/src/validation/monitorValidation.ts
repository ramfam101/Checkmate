...
export const createMonitorBodyValidation = z.object({
	...
	escalationDelay: z.number().min(1).max(10080).optional(),
	escalationRecipients: z.array(z.string().email("Invalid email address")).optional(),
});
...
const importedMonitorSchema = z.object({
	...
	escalationDelay: z.number().min(1).max(10080).default(60),
