...
const monitorEscalationSchema = z.object({
...
export const createMonitorBodyValidation = z.object({
	...
	notificationEscalations: z.array(monitorEscalationSchema).max(20).optional(),
...
const importedMonitorSchema = z.object({
	...
	notificationEscalations: z.array(monitorEscalationSchema).default([]),
	secret: z.string().optional(),
