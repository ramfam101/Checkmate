...
export const createMonitorBodyValidation = z.object({
	...
	group: z.union([z.string().max(50).trim(), z.null()]).optional(),
...
export const editMonitorBodyValidation = z.object({
	...
	description: z.union([z.string(), z.literal("")]).optional(),
	type: z.enum(MonitorTypes, "Invalid monitor type").optional(),
	url: z.string().min(1, "URL is required").optional(),
	port: z.number().optional(),
	interval: z.number().min(15000).optional(),
	isActive: z.boolean().optional(),
	statusWindowSize: z.number().min(1).max(20).optional(),
	statusWindowThreshold: z.number().min(1).max(100).optional(),
	notifications: z.array(z.string()).optional(),
	escalationDelayMinutes: z.number().nullable().optional(),
	escalationNotifications: z.array(z.string()).optional(),
