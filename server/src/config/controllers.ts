...
import EscalationNotificationController from "../controllers/escalationNotificationController.js";
...
export interface InitializedControllers {
	...
	escalationNotificationController: EscalationNotificationController;
}
export const initializeControllers = (services: InitializedServices): InitializedControllers => {
	return {
		...
		escalationNotificationController: new EscalationNotificationController(services.escalationNotificationsRepository),
	};
};
