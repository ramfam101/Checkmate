...
import EscalationNotificationRoutes from "../routes/escalationNotificationRoute.js";
...
export const setupRoutes = (app: Application, controllers: InitializedControllers, services: InitializedServices) => {
	...
	const escalationNotificationRoutes = new EscalationNotificationRoutes(controllers.escalationNotificationController);
	...
	app.use("/api/v1/escalation-notifications", verifyJWT, escalationNotificationRoutes.getRouter());
};
