...
export interface INotificationsService {
	...
	sendEscalatedNotifications: (monitor: Monitor, monitorStatusResponse: MonitorStatusResponse, notificationIds: string[]) => Promise<boolean>;
...
export class NotificationsService implements INotificationsService {
	...
	sendEscalatedNotifications = async (monitor: Monitor, monitorStatusResponse: MonitorStatusResponse, notificationIds: string[]): Promise<boolean> => {
