...
export interface INotificationsService {
	...
	send: (notification: Notification, monitor: Monitor, monitorStatusResponse: MonitorStatusResponse | null, decision: MonitorActionDecision | null, notificationMessage: NotificationMessage) => Promise<boolean>;
...
export class NotificationsService implements INotificationsService {
	...
	private sendNotifications = async (monitor: Monitor, monitorStatusResponse: MonitorStatusResponse, decision: MonitorActionDecision) => {
		const notificationIds = monitor.notificationConfig?.map(config => config.notificationId) ?? [];
