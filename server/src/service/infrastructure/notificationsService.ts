...
export interface INotificationsService {
	...
	handleEscalationNotification: (monitor: Monitor, monitorStatusResponse: MonitorStatusResponse, decision: MonitorActionDecision, channelId: string) => Promise<boolean>;
...
export class NotificationsService implements INotificationsService {
	...
	handleEscalationNotification = async (
		monitor: Monitor,
		monitorStatusResponse: MonitorStatusResponse,
		decision: MonitorActionDecision,
		channelId: string
		...
		try {
			...
			this.logger.warn({
				message: `Failed to send escalation notification for channel ${channelId}`,
				service: SERVICE_NAME,
