...
export interface INotificationsService {
	...
	sendEscalationNotifications: (notificationIds: string[], monitor: Monitor, monitorStatusResponse: MonitorStatusResponse, decision: MonitorActionDecision) => Promise<boolean>;
