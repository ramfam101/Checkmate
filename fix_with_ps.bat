...
REM Use PowerShell to replace the file completely
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  "[System.IO.File]::WriteAllText('c:\Users\SeaDo\VSCode Projects\Checkmate\client\src\Components\monitors\EscalationRulesDialog.tsx', @'
